...
class AddPaymentStatusAndMidtransUrlAndMidtransBookingCodeInChekcoutsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('checkouts', function (Blueprint $table) {
            $table->boolean('payment_status')->default(false)->nullable()->after('trip_id');
